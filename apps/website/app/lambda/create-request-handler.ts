...
import type { CloudFrontHeaders, CloudFrontRequestEvent, CloudFrontRequestHandler } from 'aws-lambda';

export type GetLoadContextFunction = (event: CloudFrontRequestEvent) => AppLoadContext;
...
export function createRequestHandler({
  ...
  return (async (event, context) => {
    ...
    const response = (await handleRequest(request as unknown as Request, loadContext)) as unknown as Response;
